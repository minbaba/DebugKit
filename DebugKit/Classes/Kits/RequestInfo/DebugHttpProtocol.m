...
static NSString * const myProtocolKey = @"mbbHttpProtocol";

@interface DebugHttpProtocol()<NSURLConnectionDelegate, NSURLConnectionDataDelegate>
...
- (void)stopLoading {
    ...
    HttpDebugModel* model = [[HttpDebugModel alloc] init];
